            ...
            <div className="row footer-row">
              ...
              <div className="col-sm-6 col-lg-3 mb-30">
                ...
                <div className="footer-widget mt-8">
                  ...
                  >
                    <li>
                      <Link to="https://www.facebook.com/kumar.vishal.320627/" className="facebook ">
                        <i className="bx bxl-facebook"></i>
                      </Link>
                    </li>
                    <li>
                      <Link to="https://x.com/vishal92336451?fbclid=IwY2xjawKc8p5leHRuA2FlbQIxMABicmlkETFXRkdlQVZSQkh2bTZCWWxYAR5lAouEH2y4R1gj9ioPRUM36JOvuGklolKqeCTcsD0DKqUDt4wqOAvFnNqWCg_aem_9Gvs_NC8Wr434E0B9VseZQ" className="twitter">
                        <i className="bx bxl-twitter"></i>
                      </Link>
                    </li>
                    <li>
                      <Link to="https://www.instagram.com/kumar_vishal1625/" className="instagram ">
                        <i className="bx bxl-instagram"></i>
                      </Link>
                    </li>
                    <li>
                      <Link to="https://www.linkedin.com/in/vishal-kumar-66a349218/" className="linkedin">
            ...
            <div className="container text-center">
              <div className="footer-copy">
                <div className="copyright">
                  ...
                  <Link
                    to="https://vkiranastore.netlify.app/portfallio"
                    target="_blank"
                  >
                    @vishalkumar
                  </Link>
